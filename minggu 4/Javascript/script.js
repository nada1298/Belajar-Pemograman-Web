...
const onSubmit = btnSubmit.addEventListener('click', function (event) {
    ...
    const nilaiTugas = document.getElementById('ntugas');
    const nilaiUts = document.getElementById('nuts');
    const nilaiUas = document.getElementById('nuas');
    const nilaiAkhir = document.getElementById('nakhir');
