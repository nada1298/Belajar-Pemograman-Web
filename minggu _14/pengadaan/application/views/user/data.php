                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('user/edit/') . $user['id_user'] ?>" class="badge badge-warning">Edit</a>
                                <a onclick="return confirm('Yakin ingin menghapus data?')" href="<?= base_url('user/delete/') . $user['id_user'] ?>" class="badge badge-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach;
                else : ?>
